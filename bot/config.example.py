...
# Manager Bot (for manager notifications)
# Optional: create a second bot for manager notifications
MANAGER_BOT_TOKEN = "987654321:ZYXwvutsRQponMLKjihGFEcba"
MANAGER_CHAT_ID = 123456789  # Your Telegram numeric chat ID (use @userinfobot)
